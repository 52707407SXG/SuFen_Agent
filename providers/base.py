...
def _profile_user_agent() -> str:
    """Return a ``sufen-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from sufen import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"sufen-cli/{_ver}"
    except Exception:
        return "sufen-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # sufen-cli UA so the catalog endpoint is reachable.
